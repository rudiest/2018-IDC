			...
			<div class="right-col">
				...
				<div class="profile-content">
					...
					<ul id="profile-tabs" class="nav nav-tabs">
						<li class="active">
							<a href="#profile-tabs-board" data-toggle="tab">Data Aset</a>
						</li>
						<li>
							<a href="#profile-tabs-activity" data-toggle="tab">Spesifikasi</a>
						</li>
						<li>
							<a href="#profile-tabs-activity" data-toggle="tab">History Lokasi</a>
						</li>
						<li>
							<a href="#profile-tabs-activity" data-toggle="tab">Log Kejadian</a>
						</li>
                                                <li>
							<a href="#profile-tabs-activity" data-toggle="tab">Log Perubahan</a>
						</li>
                                                <li>
							<a href="#profile-tabs-following" data-toggle="tab">Arsip</a>
						</li>
                                                 <li>
							<a href="#profile-tabs-following" data-toggle="tab">Foto</a>
						</li>
					</ul>
