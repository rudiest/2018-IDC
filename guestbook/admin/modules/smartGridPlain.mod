...
class smartGridPlain extends SM_module {
    ...
    function buildDefaultInnerWrapper($data = '') {
        ...
        if ($this->directive['grid_btnDetail']) {
             $html .= ' <td width="30" align="left" valign="top" style="border:1px solid #CACACA;"> &nbsp;</td>'.chr(13);
        }

        if ($this->directive['grid_btnEdit']) {
            $html .= ' <td width="20" align="left" valign="top" style="border:1px solid #CACACA;"> &nbsp;</td>'.chr(13);
        }
        ...
        $html .= ' <td width="20" align="left" valign="top" style="border:1px solid #CACACA;">'.chr(13);
        $html .= ' No. '.chr(13);
        $html .= ' </td>'.chr(13);
        $width = ' ';
        $align = ' ';
        ...
        while (list($key, $val) = each($grid_fields)) {
             ...
             $html .= ' <td '.$width.' '.$align.' valign="'.$valign.'" style="border:1px solid #CACACA;">'.chr(13);
             $html .= '  '.$val.chr(13);
             $html .= ' </td>'.chr(13);
        }
        $html .= '</tr>'.chr(13);
        ...
        while (list($key1, $val1) = each($outputData)) {
            ...
            if ($this->directive['grid_btnDetail']) {
                ...
                $html .= ' <td align="left" valign="top" style="border:1px solid #CACACA;">'.chr(13);
                $html .= $html_btnDetail;
                $html .= ' </td>'.chr(13);
            }
            ...
            $html .= ' <td align="'.$align.'" valign="'.$valign.'" style="border:1px solid #CACACA;">'.chr(13);
            $html .= '  '.$noUrut.chr(13);
            $html .= ' </td>'.chr(13);
            reset($grid_fields);
            while (list($key, $val) = each($grid_fields)) {
        ...
        if (strtolower($this->directive['grid_total']) == 'sum') {
            ...
            $html .= ' <td align="left" valign="top" style="border:1px solid #CACACA;"> &nbsp;</td>'.chr(13);
