...
class smartGridKendo extends SM_module {
    ...
    function buildDataSource() {
        ...
        $this->elmnt_jsScriptInJqReady .= '      transport: { read: { url: "'.$urlRead.'", data: { wSQL: 1, q: function() { return $("#elh_'.$this->directive['sgk_id'].'_searchbox").val(); } }, dataType: "json" } '.chr(13);
        ...
        if ($this->directive['grid_crud']) {
            ...
            if ($this->directive['grid_crud_iscreate']) {
                ...
                $this->elmnt_jsScriptInJqReady .= ', create: { url: "'.$urlCreate.'", data: { wSQL: 1, q: function() { } }, dataType: "json" } '.chr(13);
            }
            ...
            if ($this->directive['grid_crud_isedit']) {
                ...
                $this->elmnt_jsScriptInJqReady .= ', update: { url: "'.$urlEdit.'", data: { wSQL: 1, q: function() { } }, dataType: "json" } '.chr(13);
            }
            ...
            if ($this->directive['grid_crud_isdelete']) {
                ...
                $this->elmnt_jsScriptInJqReady .= ', destroy: { url: "'.$urlDelete.'", data: { wSQL: 1, q: function() { } }, dataType: "json" } '.chr(13);
            }
    ...
    function buildGrid() {
        ...
        if ($this->directive['grid_ispageable'])
            $this->elmnt_jsScriptInJqReady .= '      pageable: true,'.chr(13);
        else
    ...
    function buildElementEntity($element = '') {
        ...
        switch($element) {
            ...
            case 'search' : $html .= '<input type="text" class="k-textbox" id="elh_'.$this->directive['sgk_id'].'_searchbox" value="">&nbsp;'.chr(13);
            ...
            case 'download' :   // $this->directive['element_hint']
                            ...
                            $this->elmnt_jsScript .= '  $.ajax({type: "POST", url: "'.$this->ds_url.'", data: { sBtn: "dl", gF: JSON.stringify(ds_filter), gG: JSON.stringify(ds_group), gS: JSON.stringify(ds_sort) }, success: function(data) { window.open(data,"_blank"); }, dataType: "text" }); '.chr(13);

                            $this->elmnt_jsScript .= '}'.chr(13);

                            $html .= '<a href="#" id="elh_'.$this->directive['sgk_id'].'_download_btn" onclick="jsf_'.$this->directive['sgk_id'].'_download()" class="k-button k-button-icontext" style="width:110px; height:25px; font-size: 14px; font-weight: bold; vertical-align: middle; padding-top:3px;" ><span class="k-icon" style="background-image: url(\'./images/app/icobtn_download.png\');"></span>Download</a>';
            ...
            case 'print' :   // $this->directive['element_hint']
                            ...
                            $this->elmnt_jsScript .= '  var ds_sort = ds_'.$this->directive['sgk_id'].'.sort(); '.chr(13);
                            $this->elmnt_jsScript .= '  var ds_group = ds_'.$this->directive['sgk_id'].'.group(); '.chr(13);
                            $this->elmnt_jsScript .= '  $.ajax({type: "POST", url: "'.$this->ds_url.'", data: { sBtn: "pRn", gF: JSON.stringify(ds_filter), gG: JSON.stringify(ds_group), gS: JSON.stringify(ds_sort) }, success: function(data) { window.open(data,"_blank"); }, dataType: "text" }); '.chr(13);

                            $this->elmnt_jsScript .= '}'.chr(13);

                            $html .= '<a href="#" id="elh_'.$this->directive['sgk_id'].'_print_btn" onclick="jsf_'.$this->directive['sgk_id'].'_print()" class="k-button k-button-icontext" style="width:90px; height:25px; font-size: 14px; font-weight: bold; vertical-align: middle; padding-top:3px;" ><span class="k-icon" style="background-image: url(\'./images/app/icobtn_print.png\');"></span>Print</a>';
            ...
            case 'custom' :
                            ...
                            */
							...
							$html .= '<a href="#" id="elh_'.$this->directive['sgk_id'].'_custom_btn" onmousedown="'.$this->directive['gridBtnCustom_js'].'" class="k-button" style="height:32px; vertical-align:middle;">'.$this->directive['gridBtnCustom_label'].'</a>';
    ...
    function buildDefaultInnerWrapper($data = '') {
        ...
        switch ($this->directive['innerwrapper_useDefault_type']) {
            ...
            case '3x3' : $html .= '<table width="100%" border="0" cellspacing="0" cellpadding="4">'.chr(13);
                         $html .= '<tr>'.chr(13);
                         $html .= ' <td align="left" valign="top" width="30%">'.chr(13);
                         $html .= '  '.$this->buildElement($this->directive['inw3x3_headleft']).chr(13);
                         $html .= ' </td>'.chr(13);
                         $html .= ' <td align="center" valign="top" width="40%">'.chr(13);
                         $html .= '  '.$this->buildElement($this->directive['inw3x3_head']).chr(13);
                         $html .= ' </td>'.chr(13);
                         $html .= ' <td align="right" valign="top" width="30%">'.chr(13);
