...
-->
	<div id="main-menu" role="navigation">
		<div id="main-menu-inner">
			...
			<ul class="navigation">
				<li>
					<a href="index.php"><i class="menu-icon fa fa-dashboard"></i><span class="mm-text">Beranda</span></a>
				</li>
                                <li class="mm-dropdown">
					...
					<ul>
						...
						<li class="mm-dropdown">
							...
							<ul>
								<li>
									<a tabindex="-1" href="dashboard.php?page=addaset"><span class="mm-text">Tambah Data</span></a>
								</li>
                                                                <li>
									<a tabindex="-1" href="pages-inbox.html"><span class="mm-text">List Data</span></a>
								</li>
                                                        </ul>
                                                </li>
                                                <li class="mm-dropdown">
							...
							<ul>
								<li>
									<a tabindex="-1" href="pages-inbox.html"><span class="mm-text">Tambah Domain</span></a>
								</li>
                                                                <li>
									<a tabindex="-1" href="pages-inbox.html"><span class="mm-text">List Domain</span></a>
								</li>
                                                        </ul>
                                                </li>
                                                 <li class="mm-dropdown">
							...
							<ul>
								<li>
									<a tabindex="-1" href="pages-inbox.html"><span class="mm-text">Tambah Ip</span></a>
								</li>
                                                                <li>
									<a tabindex="-1" href="pages-inbox.html"><span class="mm-text">List Ip</span></a>
								</li>
                                                        </ul>
                                                </li>
                                        </ul>
...
<?php 
if(isset($_GET['page'])&&($_GET['page']='addasset'))
{
				...
				<div class="stat-panel">
					<div class="stat-row">
						...
						<div class="stat-cell col-sm-4 padding-sm-hr bordered no-border-r valign-top">
							...
							<h4 class="padding-sm no-padding-t padding-xs-hr"><i class="fa fa-cloud-upload text-primary"></i>&nbsp;&nbsp;Data Perangkat</h4>
							<!-- Without margin -->
							<ul class="list-group no-margin">
								<!-- Without left and right borders, extra small horizontal padding, without background, no border radius -->
								<li class="list-group-item no-border-hr padding-xs-hr no-bg no-border-radius">
									Total Server <span class="label label-pa-purple pull-right">34</span>
								</li> <!-- / .list-group-item -->
								<!-- Without left and right borders, extra small horizontal padding, without background -->
								<li class="list-group-item no-border-hr padding-xs-hr no-bg">
									Server Tidak Aktif <span class="label label-danger pull-right">128</span>
								</li> <!-- / .list-group-item -->
								...
								<li class="list-group-item no-border-hr no-border-b padding-xs-hr no-bg">
									Server Aktif <span class="label label-success pull-right">12</span>
								</li> <!-- / .list-group-item -->
							</ul>
						</div> <!-- /.stat-cell -->
							...
							<div class="stat-row">
								...
								<div class="stat-cell bordered no-border-t no-padding-hr">
									<div class="pie-chart" data-percent="43" id="easy-pie-chart-1">
										<div class="pie-chart-label">108</div>
									</div>
								</div>
							</div> <!-- /.stat-row -->
						</div> <!-- /.stat-panel -->
							...
							<div class="stat-row">
								...
								<div class="stat-cell bordered no-border-t no-padding-hr">
									<div class="pie-chart" data-percent="93" id="easy-pie-chart-2">
										<div class="pie-chart-label">445</div>
									</div>
								</div>
							</div> <!-- /.stat-row -->
						</div> <!-- /.stat-panel -->
			...
			<div class="col-md-6">
				<div class="panel panel-success widget-support-tickets" id="dashboard-support-tickets">
					<div class="panel-heading">
						<span class="panel-title"><i class="panel-title-icon fa fa-bullhorn"></i>Last Login Admin</span>
...
-->
			...
			<div class="col-md-6">
				...
				<div class="panel panel-warning" id="dashboard-recent">
					<div class="panel-heading">
						<span class="panel-title"><i class="panel-title-icon fa fa-fire text-danger"></i>Recent Pengunjung</span>
